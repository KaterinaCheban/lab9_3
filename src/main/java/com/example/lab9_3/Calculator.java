...
public class Calculator extends JFrame
{
	...
	private void initializeComponent()
	{
		...
		addComponent(contentPane, jLabel1, 36,266,160,20);
		addComponent(contentPane, jTextField1, 18,14,200,25);
		addComponent(contentPane, jButtonBack, 21,44,91,25);
		addComponent(contentPane, jButtonClear, 128,44,91,25);
		addComponent(contentPane, jButton1, 21,170,50,40);
		addComponent(contentPane, jButton2, 71,170,50,40);
		addComponent(contentPane, jButton3, 121,170,50,40);
		addComponent(contentPane, jButton4, 21,122,50,40);
		addComponent(contentPane, jButton5, 71,122,50,40);
		addComponent(contentPane, jButton6, 121,122,50,40);
		addComponent(contentPane, jButton7, 21,74,50,40);
		addComponent(contentPane, jButton8, 71,74,50,40);
		addComponent(contentPane, jButton9, 121,74,50,40);
		addComponent(contentPane, jButtonMinus, 171,170,50,40);
		addComponent(contentPane, jButtonPlus, 171,218,50,40);
		addComponent(contentPane, jButtonMul, 171,122,50,40);
		addComponent(contentPane, jButtonDiv, 171,74,50,40);
		addComponent(contentPane, jButton0, 21,218,50,40);
		addComponent(contentPane, jButtonDot, 71,218,50,40);
		addComponent(contentPane, jButtonEqual, 121,218,50,40);
		//
		// Calculator
		//
